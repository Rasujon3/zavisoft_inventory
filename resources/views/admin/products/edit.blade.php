            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('/products')}}">All Products</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                       placeholder="Products Name" required="" value="{{old('name',$product->name)}}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sku" class="form-control" id="sku"
                                       placeholder="SKU" required="" value="{{old('sku',$product->sku)}}">
                                @error('sku')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="purchase_price" class="form-control" id="purchase_price"
                                       placeholder="Purchase Price" required="" value="{{old('purchase_price',$product->purchase_price)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sell_price" class="form-control" id="sell_price"
                                       placeholder="Sell Price" required="" value="{{old('sell_price',$product->sell_price)}}">
                                @error('sell_price')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="opening_stock" class="form-control" id="opening_stock"
                                       placeholder="Opening Stock" required="" value="{{old('opening_stock',$product->opening_stock)}}">
                                @error('opening_stock')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
